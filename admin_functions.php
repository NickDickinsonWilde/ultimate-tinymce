...
function jwl_settings_api_init() {
	...
	add_settings_field('jwl_user_roles_editor', __('Editor','jwl-ultimate-tinymce'), 'jwl_user_roles_editor_callback_function', 'ultimate-tinymce5', 'jwl_setting_section5');
	...
	register_setting('jwl_options_group','jwl_user_roles_editor');
}
