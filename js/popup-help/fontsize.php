<html><head>
<title>Font Size Select Box</title>
...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Font Size Select Box:</strong></span>
<br />
This option will enable the Font Size Select Box.  This button will be added to row three of the visual editor.
